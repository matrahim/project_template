...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12">
            <div class="card-box">
                <h4 class="header-title mt-0 mb-3">Form Tambah Surat Keluar</h4>

                <form action="/surat_keluar/save" method="POST">
                    <?= csrf_field() ?>
                    <div class="row">

                        <div class=" form-group col-xl-6">
                            <label for="no_surat">No Surat</label>
                            <input type="text" name="no_surat" placeholder="Nomor Surat" class="form-control <?= ($validation->hasError('no_surat')) ? 'is-invalid' : ""; ?>" value="<?= old('no_surat'); ?>">
                        ...
                        <div class=" form-group col-xl-6">
                            ...
                            <input type="date" name="tgl_srt" placeholder="Tanggal Surat" class="form-control <?= ($validation->hasError('tgl_srt')) ? 'is-invalid' : ""; ?>" value="<?= old('tgl_srt'); ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        ...
                        <div class=" form-group col-xl-6">
                            ...
                            <select name="id_jenissurat" class="custom-select <?= ($validation->hasError('id_jenissurat')) ? 'is-invalid' : ""; ?>">
                                <option value="" <?= old('id_jenissurat') == "" ? "selected" : ""; ?>>Pilih Jenis Surat</option>
                                <?php foreach ($jenis_surat as $row) : ?>
                                    <option <?= old('id_jenissurat') == $row['id_jenissurat'] ? "selected" : ""; ?> value="<?= $row['id_jenissurat'] ?>"><?= $row['nama_jenissurat'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class=" form-group col-xl-6">
                            ...
                            <select name="id_penduduk" id="penduduk_sk" class="form-control select2 <?= ($validation->hasError('id_penduduk')) ? 'is-invalid' : ""; ?>">
                                ...
                                <?php foreach ($penduduk as $row) : ?>
                                    <option <?=
                                            old('id_penduduk') == $row['id_penduduk'] ? "selected" : "";
